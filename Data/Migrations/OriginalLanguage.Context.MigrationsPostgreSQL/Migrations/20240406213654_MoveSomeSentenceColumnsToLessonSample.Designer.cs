...
namespace OriginalLanguage.Context.MigrationsPostgreSQL.Migrations
{
    ...
    [Migration("20240406213654_MoveSomeSentenceColumnsToLessonSample")]
    partial class MoveSomeSentenceColumnsToLessonSample
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.ConlangData", b =>
                {
                    ...
                    b.Property<bool>("FurrySpeakers")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotHumanoidSpeakers")
                        .HasColumnType("boolean");

                    b.Property<int>("Origin")
                        .HasColumnType("integer");

                    b.Property<int>("SettingOrigin")
                        .HasColumnType("integer");

                    b.Property<int>("SubjectiveComplexity")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("conlang_data", (string)null);
                });
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.Language", b =>
                {
                    ...
                    b.Property<string>("AboutNativeSpeakers")
                        .HasMaxLength(3000)
                        .HasColumnType("character varying(3000)");
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.LessonSample", b =>
                {
                    ...
                    b.Property<string>("MainTranslation")
                        .HasColumnType("text");

                    b.Property<int>("MinimalProgressLevel")
                        .HasColumnType("integer");

                    b.Property<string>("TextHints")
                        .HasColumnType("text");

                    b.Property<string>("Transcription")
                        .HasColumnType("text");

                    b.Property<string>("TranslationHints")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("OriginalLanguage.Context.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.Article", b =>
                {
                    b.HasOne("OriginalLanguage.Context.Entities.AppUser", "Author")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.Language", b =>
                {
                    ...
                    b.HasOne("OriginalLanguage.Context.Entities.ConlangData", "ConlangData")
                        .WithOne("Language")
                        .HasForeignKey("OriginalLanguage.Context.Entities.Language", "ConlangDataId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("Author");

                    b.Navigation("ConlangData");
                });
            ...
            modelBuilder.Entity("OriginalLanguage.Context.Entities.LessonProgress", b =>
                {
                    ...
                    b.HasOne("OriginalLanguage.Context.Entities.AppUser", "User")
                        .WithMany("LessonProgresses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
